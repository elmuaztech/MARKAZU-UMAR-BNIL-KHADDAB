...
export function ResultPreviewModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 font-poppins">
      <div className="bg-white dark:bg-[#042419] border border-slate-200 dark:border-emerald-500/40 rounded-3xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden shadow-2xl text-slate-900 dark:text-white">
        {/* Header (Fixed) */}
        ...
        <div className="shrink-0 p-4 sm:p-5 flex items-center justify-end gap-3 border-t border-slate-200 dark:border-emerald-800/60 bg-slate-50/50 dark:bg-[#021810]">
