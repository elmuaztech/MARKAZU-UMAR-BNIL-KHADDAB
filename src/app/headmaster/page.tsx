...
export default function HeadmasterPortalPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f8f5] dark:bg-[#031c13] text-slate-900 dark:text-gray-100 flex font-sans selection:bg-emerald-500 selection:text-white relative">
