            ...
            <div className="space-y-4">
                ...
                <div className="p-4 bg-slate-100 dark:bg-[#021810] border-b border-emerald-500/20 flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 dark:text-emerald-400/80">
                      Create, manage, delete, or reset passwords for School Admins, Section Headmasters, Teachers, Parents, and Students.
                    </p>
                  </div>
              ...
              {showCreateModal && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                  <div className="max-w-lg w-full glass-panel border border-emerald-500/30 rounded-3xl p-6 space-y-5 shadow-2xl">
